                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: ({ ...props }: OrderTien) => (
                            <p className="m-0">{props.customerResponse?.lastName + ' ' + props.customerResponse?.firstName}</p>
                        ),
                    },
                    {
                    ...
                    {
                        title: () => <TableHeaderCell key="totalAmount" sortKey="totalAmount" label="Tổng tiền" />,
                        width: 400,
                        key: 'totalAmount',
