        ...
        <div className="flex flex-col w-full gap-2">
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '1rem', marginTop: '1rem' }}>
                <Search
                    ...
                    style={{ width: '30%' }} // Đặt chiều rộng của thanh tìm kiếm thành 50%
                />
            </div>
            ...
            <TableBuilder<Station>
                ...
                columns={[
                    ...
                    {
                        title: () => <TableHeaderCell key="name" label="Số lượng đơn hàng" />,
                        width: 400,
                        key: 'name',
                        render: ({ ...props }: Station) => {
                            return <TableBodyCell label={<p className="m-0">{props.totalOrderPending}</p>} />;
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: ({ ...props }: Station) => (
                            <Button
                                disabled={props.totalOrderPending === 0} // Vô hiệu hóa nút nếu không có đơn hàng đang chờ
                                onClick={() => {
                                    router.push({
