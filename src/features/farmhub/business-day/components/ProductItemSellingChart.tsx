                    ...
                    <div className="w-1/2">
                        {isLoadingSettlement ? (
                            ...
                            <div className="w-full shrink-0 grow-0 basis-auto">
                                <h5 className="mb-5 text-xl font-bold text-center ">Thống kê doanh thu</h5>
                                <div className="flex flex-wrap">
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Tổng doanh thu</p>
                                                <p className="text-base text-neutral-600 ">{settlement?.totalSales.toLocaleString('en') + ' VNĐ'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex items-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Tổng lợi nhuận</p>
                                                <p className="text-base text-neutral-600 ">{settlement?.profit.toLocaleString('en') + ' VNĐ'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex align-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Tổng đơn hàng</p>
                                    ...
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex align-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Phí giao hàng</p>
                                                <p className="text-base text-neutral-600 ">
                                    ...
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex align-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Phí hoa hồng</p>
                                                <p className="text-base text-neutral-600 ">{settlement?.commissionFee + ' VND'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex align-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Phí hàng ngày</p>
                                                <p className="text-base text-neutral-600 ">{settlement?.dailyFee.toLocaleString('en') + ' VNĐ'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex align-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Trạng thái thanh toán</p>
                                                <p className="text-base text-neutral-600 ">
                                    ...
                                    <div className="w-full mb-12 shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-3">
                                        <div className="flex align-start">
                                            ...
                                            <div className="ml-3 grow">
                                                <p className="mb-2 font-bold ">Ngày thanh toán</p>
                                                <p className="text-base text-neutral-600 ">
