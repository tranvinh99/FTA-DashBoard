...
import { Badge, Button, Descriptions, Modal, Spin, Tabs, Tag, Tooltip } from 'antd';
...
const BusinessDayDetail: React.FC<BusinessDayDetailProps> = ({ value }) => {
    ...
    const check = (value && value.endOfRegister < new Date().toISOString()) || (value && value.regiterDay > new Date().toISOString());
            ...
            <div className="flex flex-col w-full gap-4">
                ...
                <Tabs
                    ...
                    items={[
                        ...
                        {
                            label: <p className="p-0 m-0 text-black ">Danh sách lô hàng</p>,
                            key: '2',
                            children: (
                                <>
                                    <Descriptions
                                    ...
                                    <Descriptions
                                        ...
                                        title={
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex flex-col items-end w-full gap-2 ">
                                                    <Tooltip
                                                        title="Chỉ đăng kí mở bán trong chu kì mở bán"
                                                        placement="bottom"
                                                        trigger={check ? 'hover' : 'focus'}
                                                        mouseEnterDelay={0.5}
                                                    >
                                                        <Button
                                                            type="primary"
                                                        ...
                                                        >
                                                            Thêm danh sách sản phẩm vào ngày bán
                                                        </Button>
                                                    </Tooltip>
                                                </div>
                                            </div>
                        ...
                        {
                            label: <p className="p-0 m-0 text-black ">Danh sách đơn hàng</p>,
                            key: '4',
                            children: (
                                <>
                                    <Descriptions
                                    ...
                                    >
                                        <div className="flex flex-col w-full gap-2">
                                            <TableBuilder<Batch>
                                                ...
                                                columns={[
                                                    {
                                                        title: () => <TableHeaderCell key="code" sortKey="code" label="Mã đơn hàng" />,
                                                        width: 150,
                                                        key: 'code',
...

                                                    {
                                                        ...
                                                        render: ({ ...props }: Batch) => (
                                                            <p className="m-0">{props.totalAmount.toLocaleString('en')}</p>
                                                        ),
                                                    },
