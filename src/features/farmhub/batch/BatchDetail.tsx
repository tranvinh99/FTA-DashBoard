...
import { Image, Badge, Descriptions, Tag } from 'antd';
        ...
        <>
            <div className="flex flex-col w-full gap-4">
                ...
                >
                    ...
                    <Descriptions.Item label="Ảnh nhận hàng" span={1}>
                        {value?.feedBackImage ? (
                            <Image alt="" width={64} height={64} className="rounded overflow-hidden" src={value.feedBackImage} />
                        ) : (
                            'Chưa có ảnh nhận hàng'
                        )}
                    </Descriptions.Item>
                    <Descriptions.Item label="Mô tả nhận hàng" span={2}>
                        {value?.receivedDescription ? value.receivedDescription : 'Chưa có phản hồi'}
                    </Descriptions.Item>
                </Descriptions>
                <Descriptions
                    labelStyle={{
