            ...
            <div className="flex flex-col w-full gap-4">
                    ...
                    extra={
                        <div className="flex gap-5 items-center">
                            ...
                            <button
                                ...
                                className="flex items-center gap-1 px-2 py-1 text-white duration-300 hover:text-white hover:bg-primary/90 bg-primary"
                            >
                            ...
                            >
                                <PlusIcon className="w-4 h-4 text-white" />
                                <span>
                                    <span>Thêm sản phẩm vào danh sách bán</span>
                                </span>
                            </button>
                        </div>
                    }
                >
                    ...
                    <Descriptions.Item label="Trạng thái" span={1}>
                        <Badge
                            status={menu?.status === 'Active' ? 'success' : 'error'}
                            text={menu?.status === 'Active' ? 'Hoạt động' : menu?.status === 'PENDING' ? 'Đang chờ' : 'Chưa đăng bán'}
                        />
                    </Descriptions.Item>
