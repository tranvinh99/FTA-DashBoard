                    ...
                    <TableBuilder<OrderTien>
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                render: ({ ...props }: OrderTien) => (
                                    <p className="m-0">
                                        {props.customerResponse?.lastName + ' ' + props.customerResponse?.firstName ?? 'Không có tên'}
                                    </p>
                                ),
                                sorter: (a, b) =>
                                    (a.customerResponse?.lastName + ' ' + a.customerResponse?.firstName).localeCompare(
                                        b.customerResponse?.lastName + ' ' + b.customerResponse?.firstName
                                    ),
                            },
                            {
                                ...
                                width: 400,
                                key: 'shipAddress',
                                render: ({ ...props }: OrderTien) => <p className="m-0">{props.stationResponse?.name ?? 'Không có'}</p>,
                                sorter: (a, b) => {
                                    if (!a?.stationResponse?.name) return 1;
                                    if (!b?.stationResponse?.name) return -1;

                                    return a?.stationResponse?.name.localeCompare(b?.stationResponse?.name);
                                },
                            },
                            {
                                ...
                                width: 600,
                                key: 'totalAmount',
                                render: ({ ...props }: OrderTien) => <p className="m-0">{props.totalAmount.toLocaleString('en')}</p>,
                        ...
                        <TableBuilder<OrderDetail>
                            ...
                            columns={[
                                ...
                                },
                                {
                                    ...
                                    width: 400,
                                    key: 'unitPrice',
                                    render: ({ ...props }: OrderDetail) => <p className="m-0">{props.unitPrice.toLocaleString('en')}</p>,
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    width: 400,
                                    key: 'totalPrice',
                                    render: ({ ...props }: OrderDetail) => <p className="m-0">{props.totalPrice.toLocaleString('en')}</p>,
                                },
                            ]}
                        />
                    </div>
